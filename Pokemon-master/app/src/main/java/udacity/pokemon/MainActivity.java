...
public class MainActivity extends AppCompatActivity {
    ...
    private class GetPokemon extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String jsonString;
            try {
                jsonString = sh.makeHttpRequest(Objects.requireNonNull(createUrl(url)));
            } catch (IOException e) {
                return null;
            }
            ...
            if (jsonString != null) {
                try {
                    ...
                    for (int i = 0; i < pokemons.length(); i++) {
                        JSONObject pokemonI = pokemons.getJSONObject(i);
                        String id = pokemonI.getString("id");
                        String name = pokemonI.getString("name");
                        String candy = pokemonI.getString("candy");
